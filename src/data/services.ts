...
export const servicesData: ServiceDetail[] = [
  {
    ...
    heroTitle: 'Interior Painters Jacksonville FL - Interior Painting Services',
    heroSubtitle: 'Looking for interior painters in Jacksonville, FL? Paint-Techs LLC is the 5-star-rated interior painting contractor delivering flawless walls, ceilings, trim, and cabinets across Northeast Florida.',
...
Whether you're looking for interior house painting near me, need specialty finishes like accent walls, or require complete interior home painting services, Paint-Techs has the expertise to bring your vision to life. Our interior painting contractors are experienced with all interior surfaces including walls, ceilings, trim, doors, and more.`,
    ...
    faqs: [
      ...
      { question: 'Are you a licensed interior painting company near me in Jacksonville?', answer: 'Yes, Paint-Techs LLC is a fully licensed and insured interior painting contractor serving Jacksonville and all of Northeast Florida. If you\'re comparing interior painters near me, our in-house crew has handled walls, ceilings, and trim across Jacksonville since 2020, backed by a satisfaction guarantee.' },
    ],
    keywords: [
...
Our kitchen cabinet painting services are available throughout Jacksonville and surrounding areas including Ponte Vedra, St. Augustine, Orange Park, Fleming Island, Mandarin, and the Beaches. When you search for cabinet refinishing Jacksonville or cabinet painting near me, Paint-Techs LLC delivers professional results backed by our satisfaction guarantee.`,
    ...
    faqs: [
      ...
      { question: 'Are there cabinet painters near me in Jacksonville?', answer: 'Yes — Paint-Techs LLC is a Jacksonville-based cabinet painting company, not a national franchise, so the same local crew that quotes your kitchen also does the refinishing work. We serve Jacksonville, Ponte Vedra, St. Augustine, Orange Park, Fleming Island, Mandarin, and the Beaches, with most kitchens completed in 3-5 days at 50-70% less than full cabinet replacement.' },
    ],
...
**Long-Lasting Results:** Our proper surface preparation and premium coatings ensure your pool deck looks great for years, not months. Owner Vitor and the crew bring that same Florida climate expertise from Paint-Techs' exterior painting work to every pool deck project.`,
    ...
    faqs: [
      ...
      { question: 'Is there deck staining near me in Jacksonville?', answer: 'Yes — Paint-Techs LLC handles both pool deck coatings and traditional deck staining throughout Jacksonville, Ponte Vedra, and St. Augustine. The same local crew that quotes your deck also applies the coating or stain, with free on-site estimates and options built for Florida sun and humidity.' },
    ],
    keywords: [
