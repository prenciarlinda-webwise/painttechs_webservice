...
import { BUSINESS_INFO, SERVICES, SERVICE_AREAS, getWhatsAppLink, getPhoneLink, getEmailLink } from '@/lib/constants';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/services" className="text-teal-400 hover:text-orange-300 transition-colors font-medium">
                    View All Services →
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link href="/areas-we-serve" className="text-teal-400 hover:text-orange-300 transition-colors font-medium">
                    View All Areas →
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  >
                    <svg className="w-5 h-5 mt-0.5 text-green-500" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Container>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <Link href="/terms-of-service" className="text-gray-500 hover:text-orange-400 transition-colors">
                Terms of Service
              </Link>
              <Link href="/sitemap-page" className="text-gray-500 hover:text-orange-400 transition-colors">
                Sitemap
              </Link>
            </div>
          </div>
