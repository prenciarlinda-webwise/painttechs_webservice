...
import { getWhatsAppLink, BUSINESS_INFO, getPhoneLink } from '@/lib/constants';
...
export default function WhatsAppCTA({
  ...
  subtitle = 'Get a free quote today! Our team is ready to help you with your painting project.',
  message,
  variant = 'default',
}: WhatsAppCTAProps) {
        ...
        <Container>
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              ...
              <Button href={phoneLink} variant="outline" className="border-white text-white hover:bg-white hover:text-teal-600" external>
                Call Now
              </Button>
            </div>
          </div>
      ...
      <Container className="relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button href={phoneLink} variant="white" size="lg" external>
